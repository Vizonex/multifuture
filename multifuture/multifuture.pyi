...
class MultiFuture(Generic[_T]):
    ...
    def result(self, timeout: Union[int, float] = 0) -> _T:
        """
        ...
        Args:
            :param timeout: a float or integer in seconds to wait for the result in
                -1 assumes to wait forever until obtained. pass 0 if you wish to
                immediatley obtain without blocking.
    ...
    # I was orignally against this but I added this incase MultiFuture should be awaited on instead.
    # Know that it's use is limited and is currently discourged
